"""
OPERA contrastive learning stage.

Loads a DAPT (or base pretrained) checkpoint, wraps the encoder in the
contrastive model, and trains the multi-outcome SupCon objective.
...
def main(cfg: DictConfig) -> None:
    ...
    # Extract and load encoder weights from the checkpoint
